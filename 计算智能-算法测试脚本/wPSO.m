function [gbestx,gbestfitness,gbesthistory]=wPSO(popsize,dimension,xmax,xmin,vmax,vmin,maxiter,FuncId)
%% wPSO算法： 线性递减权重粒子群优化算法(标准PSO算法)
...
for iter = 1: maxiter
    ...
    gbesthistory(iter)= gbestfitness;
        ...
        fprintf("函数F%d: wPSO算法,第%d代，最佳适应度 = %e\n",FuncId,iter,gbestfitness);
